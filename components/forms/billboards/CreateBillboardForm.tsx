    ...
    const createBillboard = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (error instanceof ZodError) {
                console.error("BILLBOARDS/POST: ", error.message);
        ...
        <form onSubmit={createBillboard} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-slate-600">
                    Background image of the billboard which sit behind the text
                    and banner.
                </span>
                <div
                    className={cn(
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-slate-600">
                    This description accompanies the title and link button on
                    the billboard.
                </span>
                <Textarea
                    id="description"
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-slate-600">
                    Used to redirect users to appropriate page. For specific
                    products enter /products/product/&apos;productId&apos;. For
                    a featured collection enter
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-slate-600">
                    Show this billboard on the home page directly after its
                    creation.
                </span>
